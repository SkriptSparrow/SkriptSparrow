...
[![My Skills](https://skillicons.dev/icons?i=py,html,css,js,pycharm,vscode,git,flask,qt,bash,linux,obsidian,postgres,sqlite,linkedin,gmail,discord,ai&perline=9)](https://skillicons.dev)
